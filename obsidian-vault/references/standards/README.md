...
**Current aggregate version:** 1.10.0
...
|-----------|------|-----------------|
| Frontmatter schema | [frontmatter.md](frontmatter.md) | 1.1.0 |
| Body format | [body-format.md](body-format.md) | 1.1.0 |
| Tagging | [tagging.md](tagging.md) | 1.5.0 |
| Naming | [naming.md](naming.md) | 1.3.0 |
| Voice | [voice.md](voice.md) | 1.0.0 |
| Linking & aggregation | [linking.md](linking.md) | 1.0.0 |
| Versioning rules | [versioning.md](versioning.md) | 1.0.0 |

## How To Use These

When **creating** or **linting** a note, read all seven component files. They are short and independent.

The aggregate standards version (1.10.0) is what goes in the note's `standard-version` frontmatter field.
